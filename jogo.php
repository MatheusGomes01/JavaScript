	...
	<body onload="iniciaJogo()">
		<div style="float:left; width:auto; height:500px; background: #FFF; border: solid 1px #A2A2A2; margin-right: 5px;">
			<table border="0">
				<tr>
					<td>
						<img src="estourando_baloes/imagens/balao_azul_grande.png" />
					</td>
					<td>
			...
			<table border="0">
				<tr>
					<td>
						<img src="estourando_baloes/imagens/balao_azul_grande_estourado.png" />
					</td>
					<td>
			...
			<table border="0" style="width: 140px; height: 132px;">
				<tr>
					<td style="background: url('estourando_baloes/imagens/cronometro.png'); text-align: center;">
		...
		<div id="cenario" style="float: left; width: 600px; height: 500px; background: url('estourando_baloes/imagens/cenario.png'); background-position: bottom;"></div>
	</body>
